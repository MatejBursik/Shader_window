...
| `Ctrl + Alt + S` | Toggle sharing of app window on/off |
| `Ctrl + Alt + N + I` | Switch to next test image |
| `Ctrl + Alt + N + E` | Switch to next effects |
...
- **App development** : Share window (toggleable sharing of the app window which can interact with sharing/streaming/recording software)
